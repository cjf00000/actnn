...
if os.path.exists('test_set_flatten.pkl'):
    bits, y, es, losses0, losses1, qerrors, iscales = torch.load('test_set_flatten.pkl')
else:
    bits, y, es, losses0, losses1, qerrors, iscales = torch.load('test_set.pkl')
    ...
    torch.save([bits, y, es, losses0, losses1, qerrors, iscales], 'test_set_flatten.pkl')
...
# X_best = (2 ** (-2 * b.float())).view(1, -1) @ membership
